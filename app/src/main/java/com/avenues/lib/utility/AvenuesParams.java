...
public class AvenuesParams{
	...
	public static final String CCA_REQUEST = "cca_req";
	public static final String WORKING_KEY = "working_key";
	public static final String ACCESS_CODE_VALUE = "4YRUXLSRO20O8NIH";
	public static final String MERCHANT_ID_VALUE = "2";
