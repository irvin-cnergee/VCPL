...
public class ReleaseMacSOAP {
	private String WSDL_TARGET_NAMESPACE;
	private String SOAP_URL;
	private String METHOD_NAME;
	public String response;
	
	public ReleaseMacSOAP(String WSDL_TARGET_NAMESPACE, String SOAP_URL,
			String METHOD_NAME) {
	...
	public String releaseMac(String MemberId,String MemberLoginId,String MobileNumber)throws SocketException,SocketTimeoutException,Exception{
		...
		//Utils.log("Request MAC",""+androidHttpTransport.requestDump);
