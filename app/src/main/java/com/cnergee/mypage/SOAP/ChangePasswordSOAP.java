...
public class ChangePasswordSOAP {
	private String WSDL_TARGET_NAMESPACE;
	private String SOAP_URL;
	private String METHOD_NAME;
	public String response;
	
	public ChangePasswordSOAP(String WSDL_TARGET_NAMESPACE, String SOAP_URL,
			String METHOD_NAME) {
	...
	public String ChangePassword(String MemberId,String MemberLoginId,String oldPwd,String newPwd)throws SocketException,SocketTimeoutException,Exception{
