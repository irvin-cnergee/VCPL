...
public class GetAdditionalAmountSOAP {
	...
	public GetAdditionalAmountSOAP(String WSDL_TARGET_NAMESPACE, String SOAP_URL,
			String METHOD_NAME) {
	...
	public String getAddtionalAmount(String SubscriberId,String PackageId,String DynamicPackageRate) throws SocketException,SocketTimeoutException,Exception {
		...
		pi.setValue(SubscriberId);//chandra_shekhar
		...
		pi = new PropertyInfo();
		pi.setName("DynamicPackageRate");
		pi.setValue(DynamicPackageRate);
		pi.setType(String.class);
		request.addProperty(pi);
