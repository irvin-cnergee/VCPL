...
/**
 * Created by ccadmin on 4/29/2016.
 */
public class Get_EBS_SignatureSOAP {
    ...
    public Get_EBS_SignatureSOAP(String WSDL_TARGET_NAMESPACE, String SOAP_URL, String METHOD_NAME) {
        this.WSDL_TARGET_NAMESPACE = WSDL_TARGET_NAMESPACE;
        this.SOAP_URL = SOAP_URL;
        this.METHOD_NAME = METHOD_NAME;
    }

    public String getSignature(String MemberId,String PaymentGatewayType,String CliectAccessId) throws SocketException,SocketTimeoutException,Exception {
        ...
        pi = new PropertyInfo();
        pi.setName("PaymentGatewayType");
        pi.setValue(PaymentGatewayType);
        pi.setType(String.class);
        request.addProperty(pi);
