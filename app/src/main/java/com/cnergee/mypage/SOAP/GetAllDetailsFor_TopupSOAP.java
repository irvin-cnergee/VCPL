...
public class GetAllDetailsFor_TopupSOAP {
	...
	public GetAllDetailsFor_TopupSOAP(String WSDL_TARGET_NAMESPACE, String SOAP_URL,
			String METHOD_NAME) {
	...
	public String getPlanDeatilsFor_Topup(String Type,String Days,String subscriberid) throws SocketException,SocketTimeoutException,Exception {
		...
		pi = new PropertyInfo();
		pi.setName("Days");
		pi.setValue(Integer.valueOf(Days));
