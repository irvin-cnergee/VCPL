...
public class GetPlanParameterSOAP {
	...
	public GetPlanParameterSOAP(String WSDL_TARGET_NAMESPACE, String SOAP_URL,
			String METHOD_NAME) {
	...
	public String getParameter() throws SocketException,SocketTimeoutException,Exception {
		...
		try {
			...
			Utils.log("SOAP_URL","is:"+SOAP_URL);
