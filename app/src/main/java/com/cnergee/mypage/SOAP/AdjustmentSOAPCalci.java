...
public class AdjustmentSOAPCalci {
	...
	public AdjustmentSOAPCalci(String WSDL_TARGET_NAMESPACE, String SOAP_URL,
			String METHOD_NAME) {
	...
	public String CallAdjustmentAmountSOAP(String PackageRate) {
		/*Log.i("#####################", " START ");
