...
public class LogOutSOAP {
	private String WSDL_TARGET_NAMESPACE;
	private String SOAP_URL;
	private String METHOD_NAME;
	public String response;
	
	public LogOutSOAP(String WSDL_TARGET_NAMESPACE, String SOAP_URL,
			String METHOD_NAME) {
	...
	public String logOut(String MemberId,String MemberLoginId)throws SocketException,SocketTimeoutException,Exception{
		...
		//Log.i(">>>>>Request MAC<<<<<", request.toString());
		...
		//Utils.log("Request Logout",""+androidHttpTransport.requestDump);
		//Utils.log("Response Logout",""+androidHttpTransport.responseDump);
