...
public class ResetPasswordSOAP {
	private String WSDL_TARGET_NAMESPACE;
	private String SOAP_URL;
	private String METHOD_NAME;
	public String response;
	
	public ResetPasswordSOAP(String WSDL_TARGET_NAMESPACE, String SOAP_URL,
			String METHOD_NAME) {
	...
	public String resetPassword(String MemberId,String MemberLoginId)throws SocketException,SocketTimeoutException,Exception{
		...
		Utils.log("ResetPasswordSOAP Request",": "+androidHttpTransport.requestDump);
		Utils.log("ResetPasswordSOAP Respose",": "+androidHttpTransport.responseDump);
		//Object response1 = envelope.getResponse();
		//Utils.log("Notification Delted","s "+envelope.getResponse().toString());
		
		 response=  envelope.getResponse().toString();
		// Utils.log("Response Current Status","s "+response);
