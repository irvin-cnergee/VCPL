...
public class ComplaintsStatusSOAP {
	private String WSDL_TARGET_NAMESPACE;
	private String SOAP_URL;
	private String METHOD_NAME;
	public String response;
	
	public ComplaintsStatusSOAP(String WSDL_TARGET_NAMESPACE, String SOAP_URL,
			String METHOD_NAME) {
	...
	public String getComplaintStatus(String MemberId)throws SocketException,SocketTimeoutException,Exception{
